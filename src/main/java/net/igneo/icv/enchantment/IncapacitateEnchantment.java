...
public class IncapacitateEnchantment extends Enchantment {
    ...
    public static void onClientTick() {
        if (Keybindings.INSTANCE.incapacitate.isDown() && System.currentTimeMillis() >= incaCool + 10000 && EnchantmentHelper.getEnchantments(Minecraft.getInstance().player.getInventory().getArmor(1)).containsKey(ModEnchantments.INCAPACITATE.get())) {
