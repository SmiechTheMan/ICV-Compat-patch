...
import net.igneo.icv.enchantment.enchantsIntoMixin.EnchantsForMixinInject;
...
import static net.igneo.icv.enchantment.enchantsIntoMixin.EnchantsForMixinInject.*;
...
public class EnchantmentMenuMixin extends AbstractContainerMenu {
        ...
        if (pId >= 0) {
            ...
            if ((itemstack1.isEmpty() && !pPlayer.isCreative()) || (itemstack1.getCount() < 1 && !pPlayer.isCreative())) {
                ...
                this.access.execute((level, tablePos) -> {
                    ...
                    List<EnchantmentInstance> list = getChiselEnchantmentList(level,tablePos,itemstack);
                    if (!list.isEmpty()) {
    ...
    public void slotsChanged(Container pInventory) {
        ...
        EnchantsForMixinInject.updateEnchantmentListsDoer();
