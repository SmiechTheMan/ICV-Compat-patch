...
class FireRingModel : GeoModel<FireRingEntity?>() {
    ...
    override fun getModelResource(snakeBiteEntity: FireRingEntity?): ResourceLocation {
        return this.model
    }

    override fun getTextureResource(snakeBiteEntity: FireRingEntity?): ResourceLocation {
        return this.texture
    }

    override fun getAnimationResource(snakeBiteEntity: FireRingEntity?): ResourceLocation {
